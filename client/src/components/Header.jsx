...
const Header = () => {
  return (
    <div className='flex flex-col justify-center items-center text-center my-20'>
        <div className='flex items-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500 text-stone-500'>
        ...
        <button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full cursor-pointer hover:scale-105 transition-all duration-500'>
          Generate Images 
        ...
        <p className='mt-2 text-neutral-500'>Generated images from Textify</p>
    </div>
  )
}
