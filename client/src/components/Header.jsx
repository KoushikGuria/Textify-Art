...
const Header = () => {
  return (
    ...
    viewport={{ once:true }}
    >
        <motion.div className='flex items-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500 text-stone-500'
        ...
        <motion.button className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full cursor-pointer hover:scale-105 transition-all duration-500'
        ...
        <motion.p className='mt-2 text-neutral-500'
        initial={{ opacity:0 }}
        animate={{ opacity:1 }}
        transition={{ delay:1.2, duration:0.8 }}
        >Generated images from Textify</motion.p>
    </motion.div>
  )
}
